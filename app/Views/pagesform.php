...
<!-- left sider  -->
        ...
        ?>
            <div class="container">
                ...
                <form action="<?php echo base_url('insertpagesdata')?>" method="POST">
                    <div class="user__details">
                    <div class="input__box">
                        <span class="details"> Title </span>
                        <input type="text" placeholder="E.g:  title" name="title" required>
                    ...
                    <span class="details">Description</span>
                        ...
                        <input type="text"class="input__box_phone" name="description"placeholder="E.g:  Description"  required>
                    </div>
