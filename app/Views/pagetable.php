...
<!-- left sider  -->
  ...
  <div class="container">
    ...
    ?>  
    	<h1 class="fourth " style='color:blue'><span>Page</span><span>Table</span></h1>
...
$(document).ready(function () {
    const table = $('#blogTable').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?= base_url('user/pagedatatable') ?>",
            "type": "POST",
            "data": function (d) {
        ...
        "columns": [
          { "data": 0 }, // For s.no (This will be manually handled in the loop)
            ...
            { "data": 3 },  // Category for
            { "data": 4 }, 
            { "data": 5, "orderable": false}, // Edit link
            { "data": 6 , "orderable": false}  // Delete link
        ],
        "pageLength": 4,
        "lengthChange": false,
        "searching": true,
