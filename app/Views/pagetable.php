...
<a href="<?php echo base_url('pagesform')?>" class="btn btn-outline-primary">Add Pages </a>
	...
	<h1 class="fourth " style='color:blue'><span>Pages</span><span>Table</span></h1>
  ...
  <table class="rwd-table">
    <tbody>
      ...
      <?php  echo $count ++?>
        ...
        <td data-th="delete">
        <?php echo anchor('editpage?id='.$user_data['id'] , '
        ...
        <td data-th="edit">
        <?php echo anchor('deletepagedata?id='.$user_data['id'] , '
