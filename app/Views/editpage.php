...
<!-- left sider  -->
        ...
        ?>
            <div class="container">
                <div class="title"> Edit pages  </div>
           
                <form action="<?php echo base_url('updatepagedata')?>" method="POST">
                    <div class="user__details">
                    <div class="input__box">
                        <span class="details"> Title </span>
                        <input type="text" placeholder="E.g:  title" name="title" value="<?php echo $data[0]['title']?>" required>
                        <input type="hidden" placeholder="E.g:  title" name="id" value="<?php echo $data[0]['id']?>" required>
                    ...
                    <div class="input__box">
                        ...
                        <input type="email" placeholder="johnsmith@hotmail.com"  value="<?php echo $data[0]['email']?>"name="email" required>
                    </div>
                    <div class="input__box">
                        <span class="details">Phone Number</span>
                        <input type="tel"  placeholder="012-345-6789"  value="<?php echo $data[0]['Number']?>"name="number"required>
                    </div>
                    <!-- <div class="input__box">
                        <span class="details">Title</span>
                    ...
                    <span class="details">Description</span>
                        ...
                        <input type="text"class="input__box_phone" value="<?php echo $data[0]['Description']?>" name="description"placeholder="E.g:  Description"  required>
                    </div>
