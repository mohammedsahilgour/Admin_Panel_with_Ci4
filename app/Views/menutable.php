    ...
    <?php
     ...
     <div class="table-wrapper">
       ...
       <div  style="margin-left:100px">
        <a href="<?php echo base_url('menusection')?>" class="btn btn-outline-primary">Add Menu </a>
      </div>
        <table class="rwd-table">
          <tbody>
            <tr>
              ...
              <td data-th="email">
               <?php echo $user_data['permission'] ?>
              </td>
              <td data-th="delete">
                <?php echo anchor('editmenu?id='.$user_data['id'] , '
              ...
              <td data-th="edit">
                <?php echo anchor('deletemenudata?id='.$user_data['id'] , '
              ...
              <td data-th="edit">
                  <?php echo anchor('menubar?id=' . $user_data['id'], ' Add Menu', 'id=" "'); ?>
              </td>
